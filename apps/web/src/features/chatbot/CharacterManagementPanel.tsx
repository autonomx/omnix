            ...
            <div className="character-dashboard-grid">
              ...
              <section className="character-dashboard-section character-danger-zone">
                ...
                <div className="character-action-options">
                  <label><input type="checkbox" checked={actions.delete_memories} onChange={(event) => setActions({ ...actions, delete_memories: event.currentTarget.checked })} /><span><strong>Delete memories</strong><small>Remove this character’s memories and pending suggestions.</small></span></label>
                  <label><input type="checkbox" checked={actions.delete_transcripts} onChange={(event) => setActions({ ...actions, delete_transcripts: event.currentTarget.checked })} /><span><strong>Delete transcripts</strong><small>Remove this character’s transcript messages.</small></span></label>
                  <label><input type="checkbox" checked={actions.unlink_voice} onChange={(event) => setActions({ ...actions, unlink_voice: event.currentTarget.checked })} /><span><strong>Unlink voice</strong><small>Keep the voice asset but remove it from this profile.</small></span></label>
                  <label><input type="checkbox" checked={actions.archive_profile} onChange={(event) => setActions({ ...actions, archive_profile: event.currentTarget.checked })} /><span><strong>Archive profile</strong><small>Hide this character from active Character Mode selection.</small></span></label>
                </div>
