...
export const DEFAULT_SETTINGS_DOCUMENT: SettingsDocument = {
  ...
  rpg: { difficulty: 'normal', worldActivity: 'standard', economyPressure: 'relaxed' === 'normal' ? 'normal' : 'normal', combatLethality: 'normal', companions: true, permadeath: false, autosave: true, validator: true, backgroundSoftAudit: true, llmNarration: true, imageGeneration: false, tts: false, stt: false, campaignDefaults: {}, hermesAssistMode: 'review_each_step' },
