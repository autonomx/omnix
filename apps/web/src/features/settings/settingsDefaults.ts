...
export const DEFAULT_SETTINGS_DOCUMENT: SettingsDocument = {
  ...
  assistant: { personalityId: 'omnix-default', customPersonality: '', voiceId: '', autoSpeakReplies: false, speechLanguage: 'en-US', streamingAudio: true, researchDefaultMode: 'disabled' },
