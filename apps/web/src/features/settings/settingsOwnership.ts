...
export const SETTINGS_OWNERSHIP_MAP: SettingsOwnershipRecord[] = [
  ...
  { key: 'assistant.research.defaults', categoryId: 'assistant-chat', scope: 'module', currentOwner: 'browser-storage', targetOwner: 'settings-api', migration: 'centralize', source: 'omnix.chatbot.contextSettings', notes: 'Profile default for new and unconfigured conversations.' },
  { key: 'assistant.research.conversation-override', categoryId: 'assistant-chat', scope: 'session', currentOwner: 'browser-storage', targetOwner: 'session-state', migration: 'exclude', source: 'Chat session research_mode_override', notes: 'Persisted by the backend chat-session contract.' },
