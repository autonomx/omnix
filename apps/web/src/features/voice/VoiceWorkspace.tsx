        ...
        <div className="voice-dashboard-grid">
          ...
          <section className="voice-panel">
            ...
            <div className="voice-player-panel">
              ...
              <Waveform />
              <Group gap="xs"><Button size="xs" variant="light">Pause</Button><Button size="xs" variant="subtle">Back</Button><Button size="xs" variant="subtle">Forward</Button><Button size="xs" variant="subtle">Export</Button><Button size="xs" variant="subtle">Keep</Button></Group>
            </div>
          </section>
...
function AudioAssetRow({ asset }: { asset: VoiceAsset }) {
  return (
    <div className="voice-asset-row">
      <span>▶</span><span><Title order={4}>audio / voice</Title><small>{asset.storage_path}</small></span><span>Narrator</span><span>Default TTS</span><span>00:12</span><span><Button size="xs" variant="subtle">Play</Button><Button size="xs" variant="subtle">Export</Button></span>
    </div>
  );
}
