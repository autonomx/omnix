...
def archive_daily_universe_if_due(
    ...
    *,
    ...
    authorize a trade. The operator's research/narrow/freeze workflow remains the
    live AUTO PAPER authority. A bounded grace window prevents a process started
    hours later from pretending it captured the configured morning scan.
    """
