...
def _system_prompt() -> str:
    return (
        ...
        "not name tools or evidence source classes. Resolve omitted subjects such as 'it', "
        "'that issue', or 'the top two' from reference context when unambiguous; otherwise use "
        "clarification_required rather than inventing a subject. "
