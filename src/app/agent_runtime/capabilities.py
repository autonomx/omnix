...
_DEFAULT_CAPABILITIES = (
    ...
    _cap("research.web_search", "Search the web", "Run bounded provider-neutral web research and return source-grounded results without side effects.", zone="broker", effect="read", network=True, provider="Omnix Research", category="research", assistant=True, hermes=True, input_schema={"query": "search query", "max_results": "integer 1..10"}),
