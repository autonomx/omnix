...
def _normalized_browser_preview(
    ...
    Pillow is an optional image-runtime dependency. Import it only when a
    browser preview actually requires inspection so unrelated gateway routes
    can load in lightweight Live Chat and persistence processes.
    """
