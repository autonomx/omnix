...
# phrase of each accepted response use one step so its first raw chunk can be
# exposed at the minimum decoder depth. Conversation output IDs encode their
# response-local phrase index as ``-pN``.
