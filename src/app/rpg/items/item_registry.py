...
_ITEM_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ration": {
        ...
        "description": "A compact meal for road travel.",
        "effect": {
            "type": "reduce_survival_pressure",
            "resource": "hunger",
            "amount": 35,
        },
        "value": 2,
    ...
    "water_skin": {
        ...
        "stackable": True,
        "max_stack": 10,
        "tags": ["consumable", "water", "survival"],
        "description": "Clean drinking water sealed in a travel skin.",
        "effect": {
            "type": "reduce_survival_pressure",
            "resource": "thirst",
            "amount": 40,
