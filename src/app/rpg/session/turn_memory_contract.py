...
def write_turn_memory(
    ...
    *,
    ...
    facts = extract_player_memory_facts(player_input)
    memory["recent_turns"] = bounded([*memory["recent_turns"], turn_entry], RECENT_TURN_LIMIT)
    ...
    if _is_dialogue(player_input, result, facts):
        ...
        memory["dialogue_memories"] = bounded([*memory["dialogue_memories"], dialogue_entry], DIALOGUE_MEMORY_LIMIT)
