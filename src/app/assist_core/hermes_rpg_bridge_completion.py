...
ACTIVE_INTEGRATION_CHECKS = (
    ...
    "hermes_sequence_status_helpers",
    "hermes_sequence_preview_model",
    "hermes_sequence_review_request_ui",
    "hermes_sequence_state_store",
    "hermes_sequence_checkpoint_policy",
    "hermes_sequence_loop_guard",
    "hermes_sequence_approved_executor",
    "hermes_sequence_execution_result_ui",
    "hermes_sequence_job_contract",
    "hermes_sequence_job_ui",
    "hermes_assist_mode_policy",
    "hermes_rpg_context_pack",
    "hermes_sequence_planner_loop",
    "hermes_sequence_endurance_25",
    "hermes_rpg_campaign_assistant_smoke",
