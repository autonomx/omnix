...
_SYSTEM = (
    ...
    "aliases and traits are arrays of strings; other character metadata values are "
    "strings. Speaker attribution is the critical output. spans must contain exactly "
    ...
    "or attribution uncertainty. Do not return role, delivery, emotion, tone, source "
