...
from openai_api import AVAILABLE_MODELS, AVAILABLE_VOICES, app
...
class TestOpenAICompatibility:
    ...
    def test_openai_client_format(self):
        """Test that responses match OpenAI client format"""
        request_data = {
            "model": "mistral-7b-instruct-v0.2",
            "messages": [
                {"role": "user", "content": "Hello"}
    ...
    def test_openai_streaming_format(self):
        """Test that streaming responses match OpenAI format"""
        request_data = {
            "model": "mistral-7b-instruct-v0.2",
            "messages": [
