from app.rpg.session import runtime_part26
...
def test_phase13_49_runtime_part26_default_base_binding_is_not_self_reference():
    defaults = runtime_part26._apply_turn_authoritative.__kwdefaults__ or {}
    bound_base = defaults.get("_base_authoritative")

    assert bound_base is not None
    assert bound_base is not runtime_part26._apply_turn_authoritative
