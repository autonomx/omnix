...
# ---------------------------------------------------------------------------
# This block is intentionally appended instead of editing the compact/generated
# functions above. Python resolves globals when a function is called, so the
# background worker and prompt builders pick up these overrides at runtime.
