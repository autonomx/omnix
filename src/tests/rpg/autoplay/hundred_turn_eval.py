...
def summarize_hundred_turn_eval(**kwargs) -> Dict[str, Any]:
    from tests.rpg.autoplay.hundred_turn_eval_summary import (
        summarize_hundred_turn_eval as _summarize_hundred_turn_eval,
    )

    return _summarize_hundred_turn_eval(**kwargs)
