...
def test_evaluation_uses_npc_agency_summary():
    ...
    gate = evaluation["gates"]["npc_agency_present"]
    assert gate["ok"] is True
    assert gate["value"]["agency_event_count"] == 11
    assert "npc_agency_present" not in evaluation["failed_gates"]