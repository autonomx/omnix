"""Presentation-only response quality cleanup for interactive CLI review runs.

This module does not mutate simulation state or invent new mechanics.  It only
replaces weak/generic player-facing text when the turn's existing classification
and payload already support the safer, more specific presentation.
"""
...
def _set_visible_response(out: Dict[str, Any], *, narration: str, speaker: str = "", line: str = "", source: str) -> Dict[str, Any]:
