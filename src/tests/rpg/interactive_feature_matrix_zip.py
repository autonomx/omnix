...
from app.rpg.interactive_cli_state_checkpoint import apply_interactive_cli_state_checkpoints_to_matrix_result  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not bool(args.no_response_quality_cleanup):
        ...
        changed_turns = (
            ...
            + int(checkpoint_cleanup.get("changed_turns") or 0)
        )
        if changed_turns > 0:
