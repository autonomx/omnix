...
def test_ci_phase4_runtime_travel_command_resolves_canonical_destination_aliases():
    from app.rpg.locations import OLD_MILL, RUSTY_FLAGON, resolve_travel_command
...
def test_ci_phase4_runtime_travel_command_uses_guarded_resource_travel_and_records_encounter():
    from app.rpg.locations import OLD_MILL, apply_runtime_travel_command
...
def test_ci_phase4_runtime_travel_command_rejects_missing_resources_before_travel_or_encounter():
    from app.rpg.locations import OLD_ROAD, RUSTY_FLAGON, apply_runtime_travel_command
...
def test_ci_phase4_runtime_travel_command_contract_limits_claims():
    from app.rpg.locations import apply_runtime_travel_command, build_runtime_travel_command_narration_contract
...
def test_ci_phase4_runtime_travel_encounter_routing_readiness_and_exports():
    from app.rpg import locations

    readiness = locations.assert_phase4_runtime_travel_encounter_routing_ready()
    ...
    assert locations.apply_runtime_travel_command
    assert locations.resolve_travel_command
    assert locations.build_runtime_travel_command_narration_contract
