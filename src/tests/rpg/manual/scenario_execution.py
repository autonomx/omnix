...
from tests.rpg.manual.scenario_warnings import (
    _add_regression_warning,
    _build_n101_grounding_summary,
    _currency_delta_found,  # noqa: F401 - re-exported for focused tests.
    _fake_debt_expectation_warnings,
    _is_n101_gate_warning,  # noqa: F401 - re-exported for focused tests.
    _n101_grounding_warnings,
    _n101_stabilization_gate_warnings,
    _promote_turn_scenario_warnings,
    _record_regression_warnings,
    _record_scenario_error,  # noqa: F401 - imported by manual runner.
    _reset_regression_warnings,  # noqa: F401 - imported by manual runner.
    _scenario_contamination_warnings,
)
...
def _run_one_service_scenario(
    *,
    ...
    try:
        _seed_session_currency(session_id, currency)
        apply_manual_scenario_setup_by_session_id(
            session_id,
            scenario,
