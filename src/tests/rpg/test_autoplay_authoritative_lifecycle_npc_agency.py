...
def test_authoritative_lifecycle_accepts_npc_agency_summary():
    summary = {
        "ok": True,
        "requested_turns": 100,
        "turns_executed": 100,
    ...
    rebuilt = _build_authoritative_final_lifecycle_summary(
        ...
        npc_agency_summary=summary["npc_agency_summary"],
    )

    readiness = rebuilt["hundred_turn_readiness_summary"]
