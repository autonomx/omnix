...
async function setDocumentBlockAction(
  projectId: string, blockId: string, action: 'DEFAULT' | 'READ' | 'SKIP' | 'READ_ONCE',
): Promise<void> {
  const response = await fetch(
