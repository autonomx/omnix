...
export function TradingStrategiesPanel() {
  ...
  }, [universe, latestDeterministic, latestResearch, latestLearning, latestStochTrend, latestStochTrendEntry, latestIntradayLlm, researchReviews]);
