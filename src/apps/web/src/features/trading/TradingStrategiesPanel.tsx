...
export function TradingStrategiesPanel() {
  ...
  }, [universe, latestDeterministic, latestResearch, latestLearning, latestStochTrend, latestStochTrendEntry, latestStochExecutionSummary, latestIntradayLlm, researchReviews]);
